  ...
  return (
    <>
      <h3 className="font-bold text-lg mb-4 flex items-center gap-2">
        <button className="btn btn-xs btn-ghost btn-circle" onClick={onBack}>
          ←
        </button>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="modal-action">
          ...
          <button type="submit" className="btn btn-primary">
            {initialMode === "REGISTER_AND_MINT" && requiredCollateral && (!allowance || allowance < requiredCollateral)
              ? "Approve & Mint"
              : "Submit"}
          </button>
        </div>
